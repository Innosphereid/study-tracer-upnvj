...
<div x-data="{ show: true }" x-show="show" x-transition:enter="transition ease-out duration-300"
    ...
    class="p-4 mb-4 border rounded-lg flex items-start {{ $classes }} animate-fade-in" role="alert">
    ...
    <button type="button" @click="show = false"
        class="ml-auto -mx-1.5 -my-1.5 rounded-lg focus:ring-2 focus:ring-gray-400 p-1.5 inline-flex h-8 w-8 bg-transparent hover:bg-gray-200">
